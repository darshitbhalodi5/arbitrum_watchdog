                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <div className="flex flex-col sm:flex-row justify-end gap-3 sm:gap-4 mt-6">
                            ...
                            <button
                                ...
                                className="bg-gradient-to-r from-[#FF6B6B] to-[#4ECDC4] text-white px-4 sm:px-6 py-2 sm:py-3 rounded-lg hover:opacity-90 transition-all duration-200 shadow-lg hover:shadow-[#FF6B6B]/20 disabled:opacity-50 text-sm sm:text-base"
                            >
